      ...
      <div className="flex-1 overflow-y-auto bg-white">
        {conversations.length === 0 ? (
          ...
          conversations.map((conv) => {
            const isUnread = conv.unread || conv.unreadCount > 0;
            ...
            return (
              <div
                ...
                className={cn(
                  "group flex w-full cursor-pointer items-center gap-3 border-b px-4 py-4 text-left transition-all hover:bg-accent/30",
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-7 w-7 rounded-full opacity-0 group-hover:opacity-100 transition-opacity focus:opacity-100"
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete your chat with this user? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
