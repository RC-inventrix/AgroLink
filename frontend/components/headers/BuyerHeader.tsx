...
import { Bell, ShoppingCart, User, Menu, LogOut, Settings, X, Check, MessageSquare } from "lucide-react"
                ...
                <div className="flex items-center gap-2 sm:gap-6">
                    ...
                    <div className="relative" ref={notifRef}>
                        ...
                        {isNotifOpen && (
                            <div className="absolute right-0 mt-3 w-64 bg-white rounded-xl shadow-2xl py-2 text-gray-800 border border-gray-100 animate-in fade-in zoom-in-95 duration-200">
                                ...
                                {unreadCount > 0 ? (
                                    <button 
                                        onClick={() => { setIsNotifOpen(false); router.push("/buyer/chat"); }}
                                ...
                                <button onClick={() => router.push("/buyer/chat")} className="w-full py-2 text-center text-xs font-bold text-[#03230F] hover:bg-gray-50">Go to Chat Center</button>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <button 
                            ...
                            className="flex items-center gap-3 pl-4 border-l border-white/20 hover:opacity-80 transition-opacity focus:outline-none"
                        >
