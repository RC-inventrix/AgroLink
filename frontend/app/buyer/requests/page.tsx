...
import { 
    ...
    Loader2, CheckCircle, ChevronDown, MessageCircle, Truck, Phone, User, AlertTriangle, MapPin, AlignLeft, Image as ImageIcon, Navigation
} from "lucide-react"
        ...
        <div className="min-h-screen flex flex-col bg-[#F8F9FA] relative">
            ...
            <div className="max-w-5xl mx-auto py-10 px-4">
                <div className="mb-10 flex justify-between items-center text-[#03230F]">
                    <div>
                        <h1 className="text-4xl font-black uppercase">My Item Requests</h1>
                ...
                <DialogContent className="max-w-3xl rounded-[35px] p-0 overflow-hidden border-none shadow-2xl">
                    ...
                    <div className="h-[450px] w-full relative z-0 bg-gray-100">
                        {typeof window !== 'undefined' && isMapModalOpen && (
                            <MapContainer 
                                key={`${mapData.lat}-${mapData.lng}`} // Force redraw when coordinates change
