            ...
            <div className="flex items-center gap-4 sm:gap-8">
                ...
                <div className="relative" ref={notifRef}>
                    <button
                        ...
                        className="p-2 hover:bg-white/10 rounded-full transition-colors relative flex items-center justify-center"
                    >
                ...
                <div className="relative" ref={dropdownRef}>
                    <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="flex items-center gap-3 pl-6 border-l border-white/20 hover:opacity-80 transition-opacity focus:outline-none">
