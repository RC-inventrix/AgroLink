          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-[#D4A650] mb-2">{"10K+"}</div>
                <div className="text-foreground/70 font-medium">{"Active Farmers"}</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-[#D4A650] mb-2">{"50K+"}</div>
                <div className="text-foreground/70 font-medium">{"Happy Buyers"}</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-[#D4A650] mb-2">{"100K+"}</div>
                <div className="text-foreground/70 font-medium">{"Transactions"}</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-[#D4A650] mb-2">{"25+"}</div>
                <div className="text-foreground/70 font-medium">{"Countries"}</div>
              </div>
            </div>
          </div>
        </div>
