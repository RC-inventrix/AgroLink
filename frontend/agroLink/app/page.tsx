        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-3">
              <a href="/login" className="px-3 lg:px-4 py-1.5 lg:py-2 border-2 border-[#EEC044] text-white text-sm lg:text-base rounded-full hover:bg-[#EEC044] hover:text-[#03230F] transition font-semibold">
                Login
              </a>
              <a href="/register" className="px-4 lg:px-6 py-1.5 lg:py-2 bg-[#EEC044] text-[#03230F] text-sm lg:text-base rounded-full hover:bg-[#d9a83d] transition font-semibold">
                Register
              </a>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4 space-y-3 bg-[#03230F] border-t border-gray-700">
              ...
              <div className="flex gap-2 pt-2 px-2">
                <a href="/login" className="flex-1 px-3 py-2 border-2 border-[#EEC044] text-[#EEC044] rounded-full text-xs font-semibold text-center hover:bg-[#EEC044]/10 transition">
                  Login
                </a>
                <a href="/register" className="flex-1 px-3 py-2 bg-[#EEC044] text-[#03230F] rounded-full text-xs font-semibold text-center hover:bg-[#d9a83d] transition">
                  Register
                </a>
              </div>
            </div>
